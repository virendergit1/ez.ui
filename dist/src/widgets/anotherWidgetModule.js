...
angular.module("/app/src/widgets/anotherWidget/anotherWidgetTemplate.html", []).run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("/app/src/widgets/anotherWidget/anotherWidgetTemplate.html",
    "<div class=row><div class=\"panel panel-default\"><div class=panel-heading><i class=\"fa fa-bar-chart-o fa-fw\"></i> My Team's Allocation<div class=pull-right><div class=btn-group><button type=button class=\"btn btn-default btn-xs dropdown-toggle\" data-toggle=dropdown><i class=\"fa fa-gear\"></i> <span class=caret></span></button><ul class=\"dropdown-menu pull-right\" role=menu><li><a href=#>Action</a></li><li><a href=#>Another action</a></li><li><a href=#>Something else here</a></li><li class=divider></li><li><a href=#>Separated link</a></li></ul></div></div></div><div class=panel-body><div id=chart2>Account Groups By Users<div class=pull-right><a href=#>N</a> &nbsp; <a href=#>$</a> &nbsp; <a href=#>%</a>&nbsp;&nbsp;&nbsp;<div class=btn-group><button type=button class=\"btn btn-default btn-xs dropdown-toggle\" data-toggle=dropdown>Filter <span class=caret></span></button><ul class=\"dropdown-menu pull-right\" role=menu><li><a href=#>Filter1</a></li><li><a href=#>Filter2</a></li><li><a href=#>Filter3</a></li></ul></div></div></div></div></div></div>");
}]);
